...
export type LayoutActionType<TPayload> = {
    type:
        ...
        | LayoutActionTypes.CHANGE_LAYOUT_LANGUAGE;
    payload?: TPayload;
};
...
export const changeLayoutDirection = (layoutDirection: string): LayoutActionType<string> => ({
    type: LayoutActionTypes.CHANGE_LAYOUT_DIRECTION,
    payload: layoutDirection,
});

export const changeLayoutLanguage = (layoutLanguage: string): LayoutActionType<string> => ({
    type: LayoutActionTypes.CHANGE_LAYOUT_LANGUAGE,
    payload: layoutLanguage,
});